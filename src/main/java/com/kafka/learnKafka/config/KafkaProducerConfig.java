...
public class KafkaProducerConfig {
	...
	/*
	 * @Bean public ProducerFactory<String, KafkaModel> producerFactory() { return
	 * new DefaultKafkaProducerFactory<>(producerConfigs()); }
	 * 
	 * @Bean public KafkaTemplate<String, KafkaModel> kafkaTemplate(
	 * ProducerFactory<String, KafkaModel> producerFactory) { return new
